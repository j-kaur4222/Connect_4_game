...
public class Main extends Application {
    ...
    private void aboutMe() {
        ...
        alert.setHeaderText("JASLEEN KAUR");
        alert.setContentText("I love to create games and like to play with codes. "+ "Connect 4 is one of them."+
                " When I am free i love to play batminton n bla bla bla" );
        alert.show();
